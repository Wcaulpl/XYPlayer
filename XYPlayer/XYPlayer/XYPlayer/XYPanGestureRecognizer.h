...
@protocol XYPanGestureRecognizerDelegate <NSObject>
/** 进度 */
...
@interface XYPanGestureRecognizer : UIPanGestureRecognizer
/** 手势方向 */
@property (nonatomic, assign) PanDirection panDirection;

@property (weak, nonatomic) id<XYPanGestureRecognizerDelegate> panDelegate;
